    ...
    return (
        <div className="space-y-4 text-gray-300">
            <div>
                ...
                <p>C++, C, Java, Python, TypeScript, JavaScript, SQL, Go, Swift, PHP, Visual Basic, Verilog, MATLAB</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>PostgreSQL, MySQL, MongoDB, Couchbase, DynamoDB, Redis</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>Docker, Kubernetes, Jenkins, GitHub Actions, GitLab, AWS Code Pipeline, CI/CD, Git, Maven, Terraform</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>JUnit, Mockito, Spring Test, Cucumber, Rest Assured, PIT (Mutation Testing), JMeter, Swagger</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>Prometheus, CloudWatch, AWS X-Ray, Distributed Tracing, Performance Analysis</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>TCP/UDP, WebSockets, RDMA/RoCE, 802.11/802.3, ICMP, TDMA/FDMA, Zero-Copy Parsing</p>
            </div>
            <div>
                <h3 className="text-lg font-semibold text-gray-100">Systems & Platforms</h3>
                <p>Linux, macOS, Windows, Android, iOS, Distributed Systems, IoT</p>
            </div>
            <div>
